	...
	var methods={
		init:function(options){
			...
			return this.each(function(){
				...
				if(options != undefined && options.set_width != undefined){
        ...
        if (options != undefined && options.set_height != undefined && mCSB_containerH > options.set_height) {
          $this.css("height", options.set_height);
        }
        ...
        /*If height was specified, and no need of scrolling, turn height back.*/
        if (options != undefined && options.set_height != undefined) {
